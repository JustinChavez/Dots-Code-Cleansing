classdef dotsDrawableDynamicDotKinetogramAdaptorOptionQuest < dotsDrawableVertices
    % @class dotsDrawableDotKinetogram
    % Animate random dots that carry a motion signal.
    %***This one doesn't switch at all
    ...
    methods
        ...
        function self = dotsDrawableDynamicDotKinetogramAdaptorOptionQuest()
