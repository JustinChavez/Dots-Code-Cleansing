...
#           gcc version 3.2.3
            CC='g++'
            CFLAGS='-fPIC -ansi -D_GNU_SOURCE -fexceptions -m32 -ObjC'
...
#
            LD="$COMPILER"
            LDEXTENSION='.mexglx'
            LDFLAGS1="-pthread -shared -m32 -Wl,--version-script,$TMW_ROOT/extern/lib/$Arch/$MAPFILE"
...
#           gcc version 3.2.3
            CC='gcc'
            CFLAGS='-fPIC -fno-omit-frame-pointer -ansi -D_GNU_SOURCE -fexceptions -ObjC'
...
#
            LD="$COMPILER"
            LDEXTENSION='.mexa64'
            LDFLAGS1="-pthread -shared -Wl,--version-script,$TMW_ROOT/extern/lib/$Arch/$MAPFILE"
            LDFLAGS="$LDFLAGS1 -bundle -framework Foundation -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework openGL -framework QTKit"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
...
#
            LD="$COMPILER"
            LDEXTENSION='.mexsol'
            LDFLAGS1="-shared -Wl,-M,$TMW_ROOT/extern/lib/$Arch/$MAPFILE,-R,$GCC_LIBDIR"
            LDFLAGS="$LDFLAGS1 -bundle -framework Foundation -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework openGL -framework QTKit"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'  
#
...
#----------------------------------------------------------------------------
            CC='gcc'
            CFLAGS='-x objective-c -fno-common -no-cpp-precomp -fexceptions -ObjC'
            CLIBS="$MLIBS -lstdc++"
...
#
            LD="$CC"
            LDEXTENSION='.mexmac'
            LDFLAGS1="-bundle -Wl,-flat_namespace -undefined suppress -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework QTKit"
            LDFLAGS="$LDFLAGS1 -bundle -framework Foundation -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework openGL -framework QTKit"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
...
#            CC='g++-3.3'
            CC='gcc-4.0'
            CFLAGS='-x objective-c -fno-common -no-cpp-precomp -fexceptions -arch i386 -ObjC'
            CLIBS="$MLIBS -lstdc++"
            COPTIMFLAGS='-O3 -DNDEBUG'
            CDEBUGFLAGS='-g'
#
...
#
            LD="$CC"
            LDEXTENSION='.mexmaci'
            LDFLAGS1="-bundle -Wl,-flat_namespace -undefined suppress -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework QTKit -pthread"
            LDFLAGS="$LDFLAGS1 -bundle -framework Foundation -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework openGL -framework QTKit"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
...
#----------------------------------------------------------------------------
            ...
            ARCHS='x86_64'
            CFLAGS="-x objective-c -fno-common -no-cpp-precomp -arch $ARCHS -isysroot $SDKROOT -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET -Wno-deprecated-declarations -Wno-deprecated -Wno-implicit-function-declaration - ObjC"
...
#
            ...
            LDFLAGS2="-Wl,-twolevel_namespace -undefined error -arch $ARCHS -Wl,-syslibroot,$SDKROOT -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET"
            LDFLAGS1="$LDFLAGS2 -bundle -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework openGL -framework QTKit"
            LDFLAGS="$LDFLAGS1 -bundle -framework Foundation -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework openGL -framework QTKit"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
